...
for (i = 0; i<mots.length ; i++){
    var dTitle = document.getElementById("contenu").appendChild(document.createElement("dt"));
    var dPolice = dTitle.appendChild(document.createElement("strong"));
    dPolice.textContent = mots[i].terme;
    var dDefinition = document.getElementById("contenu").appendChild(document.createElement("dd"));
    dDefinition.textContent = mots[i].definition;
}
